...
\DoxyCodeLine{167        \textcolor{keywordflow}{for} (x=0; x<fbVarScreenInfo.xres; x++)}
\DoxyCodeLine{168         \{}
\DoxyCodeLine{169          pfb32[x + y * fbVarScreenInfo.xres]  = BLUE;}
\DoxyCodeLine{170         \}}
\DoxyCodeLine{171       \}}
\DoxyCodeLine{172 }
\DoxyCodeLine{173      \textcolor{comment}{/* Cleanup */}}
\DoxyCodeLine{174      munmap(pfb32, screensize);}
\DoxyCodeLine{175      close(fb\_fd);}
\DoxyCodeLine{176    \}}
