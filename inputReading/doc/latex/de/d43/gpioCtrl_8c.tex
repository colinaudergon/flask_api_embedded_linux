...
\DoxyCodeLine{488     \textcolor{comment}{// int swVal = 1;}}
\DoxyCodeLine{489     \textcolor{comment}{// swVal = readBtn(s400);}}
\DoxyCodeLine{490     \textcolor{comment}{// controlGpioOut(ds403, swVal);}}
\DoxyCodeLine{491     \textcolor{comment}{// if (swVal == 0)}}
\DoxyCodeLine{492     \textcolor{comment}{// \{}}
\DoxyCodeLine{493     \textcolor{comment}{//     inputState |= startPressed;}}
\DoxyCodeLine{494     \textcolor{comment}{//     printf("{}Switch S400 active\(\backslash\)n"{});}}
\DoxyCodeLine{495     \textcolor{comment}{// \}}}
\DoxyCodeLine{496     \textcolor{comment}{// else if (swVal < 0)}}
\DoxyCodeLine{497     \textcolor{comment}{// \{}}
\DoxyCodeLine{498     \textcolor{comment}{//     printf("{}Error"{});}}
\DoxyCodeLine{499     \textcolor{comment}{// \}}}
\DoxyCodeLine{500 }
\DoxyCodeLine{501     \textcolor{comment}{// swVal = 1;}}
\DoxyCodeLine{502     \textcolor{comment}{// swVal = readBtn(s401);}}
\DoxyCodeLine{503     \textcolor{comment}{// controlGpioOut(ds402, swVal);}}
\DoxyCodeLine{504     \textcolor{comment}{// if (swVal == 0)}}
\DoxyCodeLine{505     \textcolor{comment}{// \{}}
\DoxyCodeLine{506     \textcolor{comment}{//     inputState |= selectPressed;}}
\DoxyCodeLine{507     \textcolor{comment}{//     printf("{}Switch S401 active\(\backslash\)n"{});}}
\DoxyCodeLine{508     \textcolor{comment}{// \}}}
\DoxyCodeLine{509     \textcolor{comment}{// else if (swVal < 0)}}
\DoxyCodeLine{510     \textcolor{comment}{// \{}}
\DoxyCodeLine{511     \textcolor{comment}{//     printf("{}Error"{});}}
\DoxyCodeLine{512     \textcolor{comment}{// \}}}
\DoxyCodeLine{513     \textcolor{comment}{// swVal = 1;}}
\DoxyCodeLine{514     \textcolor{comment}{// swVal = readBtn(s402);}}
\DoxyCodeLine{515     \textcolor{comment}{// controlGpioOut(ds401, swVal);}}
\DoxyCodeLine{516     \textcolor{comment}{// if (swVal == 0)}}
\DoxyCodeLine{517     \textcolor{comment}{// \{}}
\DoxyCodeLine{518     \textcolor{comment}{//     inputState |= aPressed;}}
\DoxyCodeLine{519     \textcolor{comment}{//     printf("{}Switch S402 active\(\backslash\)n"{});}}
\DoxyCodeLine{520     \textcolor{comment}{// \}}}
\DoxyCodeLine{521     \textcolor{comment}{// else if (swVal < 0)}}
\DoxyCodeLine{522     \textcolor{comment}{// \{}}
\DoxyCodeLine{523     \textcolor{comment}{//     printf("{}Error"{});}}
\DoxyCodeLine{524     \textcolor{comment}{// \}}}
\DoxyCodeLine{525     \textcolor{comment}{// swVal = 1;}}
\DoxyCodeLine{526     \textcolor{comment}{// swVal = readBtn(s403);}}
\DoxyCodeLine{527     \textcolor{comment}{// controlGpioOut(ds400, swVal);}}
\DoxyCodeLine{528     \textcolor{comment}{// if (swVal == 0)}}
\DoxyCodeLine{529     \textcolor{comment}{// \{}}
\DoxyCodeLine{530     \textcolor{comment}{//     inputState |= bPressed;}}
\DoxyCodeLine{531     \textcolor{comment}{//     printf("{}Switch S403 active\(\backslash\)n"{});}}
\DoxyCodeLine{532     \textcolor{comment}{// \}}}
\DoxyCodeLine{533     \textcolor{comment}{// else if (swVal < 0)}}
\DoxyCodeLine{534     \textcolor{comment}{// \{}}
\DoxyCodeLine{535     \textcolor{comment}{//     printf("{}Error"{});}}
\DoxyCodeLine{536     \textcolor{comment}{// \}}}
\DoxyCodeLine{537     \textcolor{comment}{// swVal = 1;}}
