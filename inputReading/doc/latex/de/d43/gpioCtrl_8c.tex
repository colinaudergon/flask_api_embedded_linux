...
\item 
uint8\+\_\+t \textbf{ joystick\+Up\+Reading} = 0x\+FC
\item 
uint8\+\_\+t \textbf{ joystick\+Down\+Reading} = 0x\+F1
\item 
uint8\+\_\+t \textbf{ joystick\+Right\+Reading} = 0x\+FC
\item 
uint8\+\_\+t \textbf{ joystick\+Left\+Reading} = 0x\+F2
\item 
...
Definition at line 586 of file gpio\+Ctrl.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{587 \{}
\DoxyCodeLine{588     \textcolor{keywordtype}{int} max\_connection\_attempts = 10;}
\DoxyCodeLine{589     socket\_fd = socket(AF\_UNIX, SOCK\_STREAM, 0);}
\DoxyCodeLine{590     \textcolor{keywordflow}{if} (socket\_fd == -\/1)}
\DoxyCodeLine{591     \{}
\DoxyCodeLine{592         perror(\textcolor{stringliteral}{"{}Error creating socket"{}});}
\DoxyCodeLine{593         \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{594     \}}
\DoxyCodeLine{595 }
\DoxyCodeLine{596     \textcolor{keywordflow}{while} (max\_connection\_attempts > 0)}
\DoxyCodeLine{597     \{}
\DoxyCodeLine{598         \textcolor{keywordflow}{if} (connect(socket\_fd, (\textcolor{keyword}{struct} sockaddr *)\&address, \textcolor{keyword}{sizeof}(address)) == 0)}
\DoxyCodeLine{599         \{}
\DoxyCodeLine{600             printf(\textcolor{stringliteral}{"{}Connected to the server\(\backslash\)n"{}});}
\DoxyCodeLine{601             \textcolor{keywordflow}{return} \textcolor{keyword}{true}; \textcolor{comment}{// Exit the function with success}}
\DoxyCodeLine{602         \}}
\DoxyCodeLine{603         \textcolor{keywordflow}{else}}
\DoxyCodeLine{604         \{}
\DoxyCodeLine{605             perror(\textcolor{stringliteral}{"{}Error connecting to the server"{}});}
\DoxyCodeLine{606             max\_connection\_attempts-\/-\/;}
\DoxyCodeLine{607 }
\DoxyCodeLine{608             \textcolor{comment}{// Wait for a short duration before retrying}}
\DoxyCodeLine{609             sleep(1);}
\DoxyCodeLine{610         \}}
\DoxyCodeLine{611     \}}
\DoxyCodeLine{612 }
\DoxyCodeLine{613     \textcolor{comment}{// Connection attempts exhausted, handle the error as needed}}
\DoxyCodeLine{614     fprintf(stderr, \textcolor{stringliteral}{"{}Failed to establish a connection\(\backslash\)n"{}});}
\DoxyCodeLine{615     close(socket\_fd); \textcolor{comment}{// Close the socket if connection fails}}
\DoxyCodeLine{616     \textcolor{keywordflow}{return} \textcolor{keyword}{false};     \textcolor{comment}{// Exit the function with failure}}
\DoxyCodeLine{617 \}}
...
\DoxyCodeLine{280             printf(\textcolor{stringliteral}{"{}Switch S401 active\(\backslash\)n"{}});}
\DoxyCodeLine{281         \}}
...
\DoxyCodeLine{292             printf(\textcolor{stringliteral}{"{}Switch S402 active\(\backslash\)n"{}});}
\DoxyCodeLine{293         \}}
...
\DoxyCodeLine{304             printf(\textcolor{stringliteral}{"{}Switch S403 active\(\backslash\)n"{}});}
\DoxyCodeLine{305         \}}
...
\DoxyCodeLine{315         \{}
\DoxyCodeLine{316             perror(\textcolor{stringliteral}{"{}ERROR writing to socket"{}});}
...
\DoxyCodeLine{489     \{}
\DoxyCodeLine{490         printf(\textcolor{stringliteral}{"{}Failed to configure ADC"{}});}
\DoxyCodeLine{491         perror(\textcolor{stringliteral}{"{}Setup ADC"{}});}
\DoxyCodeLine{492         \textcolor{keywordflow}{return} errorCode;}
\DoxyCodeLine{493         \textcolor{comment}{// isReading = false;}}
\DoxyCodeLine{494     \}}
\DoxyCodeLine{495     adcValue = readAdcValue();}
\DoxyCodeLine{496     printf(\textcolor{stringliteral}{"{}U/D Value: \%d\(\backslash\)n"{}}, adcValue);}
\DoxyCodeLine{497 }
\DoxyCodeLine{498     \textcolor{keywordflow}{if} (adcValue == joystickUpReading)}
\DoxyCodeLine{499     \{}
\DoxyCodeLine{500         adcState |= joystickUp;}
\DoxyCodeLine{501     \}}
\DoxyCodeLine{502     \textcolor{keywordflow}{if} (adcValue == joystickLeftReading)}
\DoxyCodeLine{503     \{}
\DoxyCodeLine{504         adcState |= joystickDown;}
\DoxyCodeLine{505     \}}
\DoxyCodeLine{506 }
\DoxyCodeLine{507     sleep\_ms(20);}
\DoxyCodeLine{508     \textcolor{keywordflow}{if} (setUpAdcValue(JOYSTICK\_A\_LEFT\_RIGHT) < 0)}
\DoxyCodeLine{509     \{}
\DoxyCodeLine{510         printf(\textcolor{stringliteral}{"{}Failed to configure ADC"{}});}
\DoxyCodeLine{511         perror(\textcolor{stringliteral}{"{}Setup ADC"{}});}
\DoxyCodeLine{512         \textcolor{comment}{// isReading = false;}}
\DoxyCodeLine{513         \textcolor{keywordflow}{return} errorCode;}
\DoxyCodeLine{514     \}}
\DoxyCodeLine{515 }
\DoxyCodeLine{516     adcValue = readAdcValue();}
\DoxyCodeLine{517     \textcolor{keywordflow}{if} (adcValue == joystickRightReading)}
\DoxyCodeLine{518     \{}
\DoxyCodeLine{519         adcState |= joystickRight;}
\DoxyCodeLine{520     \}}
\DoxyCodeLine{521     \textcolor{keywordflow}{if} (adcValue == joystickLeftReading)}
\DoxyCodeLine{522     \{}
\DoxyCodeLine{523         adcState |= joystickLeft;}
\DoxyCodeLine{524     \}}
\DoxyCodeLine{525     printf(\textcolor{stringliteral}{"{}L/R Value: \%d\(\backslash\)n"{}}, adcValue);}
\DoxyCodeLine{526 }
\DoxyCodeLine{527     sleep\_ms(10);}
\DoxyCodeLine{528     \textcolor{comment}{// int swVal = 1;}}
\DoxyCodeLine{529     \textcolor{comment}{// swVal = readBtn(s400);}}
\DoxyCodeLine{530     \textcolor{comment}{// controlGpioOut(ds403, swVal);}}
\DoxyCodeLine{531     \textcolor{comment}{// if (swVal == 0)}}
\DoxyCodeLine{532     \textcolor{comment}{// \{}}
\DoxyCodeLine{533     \textcolor{comment}{//     inputState |= startPressed;}}
\DoxyCodeLine{534     \textcolor{comment}{//     printf("{}Switch S400 active\(\backslash\)n"{});}}
\DoxyCodeLine{535     \textcolor{comment}{// \}}}
\DoxyCodeLine{536     \textcolor{comment}{// else if (swVal < 0)}}
\DoxyCodeLine{537     \textcolor{comment}{// \{}}
\DoxyCodeLine{538     \textcolor{comment}{//     printf("{}Error"{});}}
\DoxyCodeLine{539     \textcolor{comment}{// \}}}
\DoxyCodeLine{540 }
\DoxyCodeLine{541     \textcolor{comment}{// swVal = 1;}}
\DoxyCodeLine{542     \textcolor{comment}{// swVal = readBtn(s401);}}
\DoxyCodeLine{543     \textcolor{comment}{// controlGpioOut(ds402, swVal);}}
\DoxyCodeLine{544     \textcolor{comment}{// if (swVal == 0)}}
\DoxyCodeLine{545     \textcolor{comment}{// \{}}
\DoxyCodeLine{546     \textcolor{comment}{//     inputState |= selectPressed;}}
\DoxyCodeLine{547     \textcolor{comment}{//     printf("{}Switch S401 active\(\backslash\)n"{});}}
\DoxyCodeLine{548     \textcolor{comment}{// \}}}
\DoxyCodeLine{549     \textcolor{comment}{// else if (swVal < 0)}}
\DoxyCodeLine{550     \textcolor{comment}{// \{}}
\DoxyCodeLine{551     \textcolor{comment}{//     printf("{}Error"{});}}
\DoxyCodeLine{552     \textcolor{comment}{// \}}}
\DoxyCodeLine{553     \textcolor{comment}{// swVal = 1;}}
\DoxyCodeLine{554     \textcolor{comment}{// swVal = readBtn(s402);}}
\DoxyCodeLine{555     \textcolor{comment}{// controlGpioOut(ds401, swVal);}}
\DoxyCodeLine{556     \textcolor{comment}{// if (swVal == 0)}}
\DoxyCodeLine{557     \textcolor{comment}{// \{}}
\DoxyCodeLine{558     \textcolor{comment}{//     inputState |= aPressed;}}
\DoxyCodeLine{559     \textcolor{comment}{//     printf("{}Switch S402 active\(\backslash\)n"{});}}
\DoxyCodeLine{560     \textcolor{comment}{// \}}}
\DoxyCodeLine{561     \textcolor{comment}{// else if (swVal < 0)}}
\DoxyCodeLine{562     \textcolor{comment}{// \{}}
\DoxyCodeLine{563     \textcolor{comment}{//     printf("{}Error"{});}}
\DoxyCodeLine{564     \textcolor{comment}{// \}}}
\DoxyCodeLine{565     \textcolor{comment}{// swVal = 1;}}
\DoxyCodeLine{566     \textcolor{comment}{// swVal = readBtn(s403);}}
\DoxyCodeLine{567     \textcolor{comment}{// controlGpioOut(ds400, swVal);}}
\DoxyCodeLine{568     \textcolor{comment}{// if (swVal == 0)}}
\DoxyCodeLine{569     \textcolor{comment}{// \{}}
\DoxyCodeLine{570     \textcolor{comment}{//     inputState |= bPressed;}}
\DoxyCodeLine{571     \textcolor{comment}{//     printf("{}Switch S403 active\(\backslash\)n"{});}}
\DoxyCodeLine{572     \textcolor{comment}{// \}}}
\DoxyCodeLine{573     \textcolor{comment}{// else if (swVal < 0)}}
\DoxyCodeLine{574     \textcolor{comment}{// \{}}
\DoxyCodeLine{575     \textcolor{comment}{//     printf("{}Error"{});}}
\DoxyCodeLine{576     \textcolor{comment}{// \}}}
\DoxyCodeLine{577     \textcolor{comment}{// swVal = 1;}}
\DoxyCodeLine{578     \textcolor{comment}{// sleep\_ms(100);}}
\DoxyCodeLine{579     printf(\textcolor{stringliteral}{"{}1) adcState: 0x\%02X\(\backslash\)n"{}}, adcState);}
\DoxyCodeLine{580     \textcolor{keywordflow}{return} adcState;}
\DoxyCodeLine{581 \}}
...
Definition at line 621 of file gpio\+Ctrl.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{622 \{}
\DoxyCodeLine{623     usleep(milliseconds * 1000);}
\DoxyCodeLine{624 \}}
...
{\footnotesize\ttfamily uint8\+\_\+t joystick\+Down\+Reading = 0x\+F1}
...
{\footnotesize\ttfamily uint8\+\_\+t joystick\+Left\+Reading = 0x\+F2}
...
{\footnotesize\ttfamily uint8\+\_\+t joystick\+Right\+Reading = 0x\+FC}
...
{\footnotesize\ttfamily uint8\+\_\+t joystick\+Up\+Reading = 0x\+FC}
