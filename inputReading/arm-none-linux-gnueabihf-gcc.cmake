...
#
# CMake include file to cross compile for the ARM32 architecture.
#
...
# System platform
set(CMAKE_SYSTEM_PLATFORM arm-none-linux-gnueabihf)
...
include_directories(${TARGET_SYSROOT}/usr/include ${TARGET_SYSROOT}/usr/local/include ${TARGET_SYSROOT}/usr/include/drm)
...
set(CMAKE_EXE_LINKER_FLAGS "-Xlinker -rpath-link=${TARGET_SYSROOT}/usr/lib -Xlinker -rpath-link=${TARGET_SYSROOT}/usr/lib/arm-linux-gnueabihf -Xlinker -rpath-link=${TARGET_SYSROOT}/usr/local/lib \
		            -Xlinker -rpath-link=${TARGET_SYSROOT}/usr/lib/arm-linux-gnueabihf/pulseaudio -Xlinker -rpath-link=${TARGET_SYSROOT}/lib/arm-linux-gnueabihf")
